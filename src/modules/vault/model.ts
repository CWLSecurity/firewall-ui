...
export const SECURITY_LINES: SecurityLineDefinition[] = [
  {
    ...
    title: 'Vault',
    shortDescription: 'Best for long-term storage and occasional withdrawals.',
    details: [
      'Use this when the Vault mostly holds funds instead of trading often.',
      'The first transfer to a new address is delayed by 1 hour.',
      'Large outgoing transfers are delayed by 1 hour.',
    ],
    includedProtectionPreview: [
      'Large transfers over 10 ETH are delayed',
      'First transfer to a new address is delayed',
    ],
  },
  {
    id: 'defi-trader',
    ...
    title: 'DeFi Trader',
    shortDescription: 'Best for active DeFi usage with guardrails still in place.',
    details: [
      'Use this when you often swap, bridge, or approve apps.',
      'Most common DeFi approval flows stay usable.',
      'First-time spenders, recipients, and some unfamiliar actions can still trigger review delays.',
    ],
    includedProtectionPreview: [
      'Most DeFi approvals stay usable, but broad operator approvals are blocked',
      'First-time approvals and first-time recipients can still be delayed',
      'Large transfers are delayed',
      'First transfer to a new personal wallet and some unfamiliar contract actions can be delayed',
    ],
  },
]
